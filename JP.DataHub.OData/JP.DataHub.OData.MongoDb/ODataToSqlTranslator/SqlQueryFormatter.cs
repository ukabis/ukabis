...
namespace JP.DataHub.OData.MongoDb.ODataToSqlTranslator
{
    ...
    public class SQLQueryFormatter : IQueryFormatter
    {
        ...
        {
            return string.Concat(source.Trim(), Constants.SymbolDot, edmProperty.Trim());
        }
        ...
        {
            return string.Concat(source.StartsWith(Constants.SQLJoinSymbol) ? source : startLetter.ToString(),
                Constants.SymbolDot, edmProperty);
        }
    }
}
