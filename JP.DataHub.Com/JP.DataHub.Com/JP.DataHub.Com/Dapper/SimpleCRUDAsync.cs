...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        public static async Task<T> GetAsync<T>(this IDbConnection connection, object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            sb.Append(" where " + GetColumnName(onlyKey) + $" = {_parameterPrefix}Id");

            var dynParms = new DynamicParameters();
            dynParms.Add($"{_parameterPrefix}id", id);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>Gets a list of entities with optional exact match where conditions</returns>
        public static Task<IEnumerable<T>> GetListPagedAsync<T>(this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            return connection.QueryAsync<T>(query, null, transaction, commandTimeout);
        }
        ...
        //}
        public static Task<Guid> InsertAsync(this IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return InsertAsync<Guid>(connection, entityToInsert, transaction, commandTimeout);
        }
        ...
        public static async Task<TKey> InsertAsync<TKey>(this IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            if (keytype != typeof(string) && keytype != typeof(int) && keytype != typeof(uint) && keytype != typeof(long) && keytype != typeof(ulong) && keytype != typeof(short) && keytype != typeof(ushort) && keytype != typeof(Guid))
            {
        ...
        /// <summary>
        /// <para>Optimistic Updates a record in the database asynchronously</para>
        /// <para>By default updates record in the table matching the class name</para>
        /// <para>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
        /// <para>Updates record where the Id property and properties with the [Key] attribute match those in the database.</para>
        /// <para>Properties marked with attribute [Editable(false)] and complex types are ignored</para>
        /// <para>Supports transaction and command timeout</para>
        /// <para>Returns number of rows effected</para>
        /// </summary>
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of effected records</returns>
        /// <throws>DBConcurrencyException</throws>
        public static async Task<int> OptimisticUpdateAsync(this IDbConnection connection, string sql, object param, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var result = await connection.ExecuteAsync(sql, param, transaction, commandTimeout);

            return result == 1 ? result : throw new DBConcurrencyException();
        }
        ...
        public static Task<int> RecordCountAsync<T>(this IDbConnection connection, string conditions = "", IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
