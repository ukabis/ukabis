...
namespace Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        //}
        public static Guid Insert(this IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return Insert<Guid>(connection, entityToInsert, transaction, commandTimeout);
        }
        ...
        public static TKey Insert<TKey>(this IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            if (keytype == typeof(Guid))
            {
                ...
                // Oracleの場合、1回のクエリで複数の文を実行することができないため、登録したIDの取得処理を行わないようにする
        ...
        /// <summary>
        /// <para>Optimistic Updates a record in the database</para>
        ...
        public static int OptimisticUpdate(this IDbConnection connection, string sql, object param, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        private static void BuildInsertValues(object entityToInsert, StringBuilder sb)
        {
            ...
            for (var i = 0; i < props.Count(); i++)
            {
                ...
                //    && property.GetCustomAttributes(true).Any(attr => attr.GetType() == (typeof(System.ComponentModel.DataAnnotations.KeyAttribute)))
        ...
        private static IEnumerable<PropertyInfo> GetUpdateableProperties(object entity)
        {
            ...
            updateableProperties = updateableProperties.Where(p => p.GetCustomAttributes(true).Any(attr => attr.GetType() == (typeof(System.ComponentModel.DataAnnotations.KeyAttribute))) == false);
        ...
        {
            var tp = type.GetProperties().Where(p => p.GetCustomAttributes(true).Any(attr => attr.GetType() == (typeof(System.ComponentModel.DataAnnotations.KeyAttribute)))).ToList();
