...
{
    [TestClass]
    public class UnitTest_OracleDbResourceSchemaAdapter : UnitTestBase
    {
...
{{
    ...
    ""additionalProperties"": false
        ...
        public void TestInitialize()
        {
            ...
            UnityContainer.RegisterType<IResourceSchemaAdapter, OracleDbResourceSchemaAdapter>(RepositoryType.OracleDb.ToCode(),
            ...
            UnityContainer.RegisterInstance<INewDynamicApiDataStoreRdbmsRepository>(RepositoryType.OracleDb.ToCode(), mockDataStoreRepository.Object);
...
{{
    ...
    ""additionalProperties"": false
        ...
        private Mock<INewDynamicApiDataStoreRdbmsRepository> SetupTableColumn(bool exists, RepositoryInfo repositoryInfo, int maxColumns = 100, int maxColumnNameBytes = 100)
        {
            ...
            mockDataStoreRepository.SetupGet(x => x.TableColumnNamePattern).Returns(OracleDbConsts.TableColumnNamePattern);
