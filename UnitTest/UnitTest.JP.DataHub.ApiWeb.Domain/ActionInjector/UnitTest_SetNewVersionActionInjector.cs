...
{
    [TestClass]
    public class UnitTest_SetNewVersionActionInjector : UnitTestBase
    {
        ...
        public void Execute_リポジトリ1つ()
        {
            ...
            var target = UnityCore.Resolve<SetNewVersionActionInjector>();
            ...
            mockResourceVersionRepository.Verify(x => x.AddNewVersion(It.IsAny<RepositoryKey>()), Times.Exactly(1));
        }
        ...
        public void Execute_リポジトリ2つ()
        {
            ...
            mockResourceVersionRepository1.Verify(x => x.AddNewVersion(It.IsAny<RepositoryKey>()), Times.Exactly(1));
            mockResourceVersionRepository2.Verify(x => x.AddNewVersion(It.IsAny<RepositoryKey>()), Times.Exactly(1));
        }
