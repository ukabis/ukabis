...
{
    [TestClass]
    public class UnitTest_CompleteRegisterVersionActionInjector : UnitTestBase
    {
        ...
        public void Execute_リポジトリ1つ()
        {
            ...
            var target = UnityCore.Resolve<CompleteRegisterVersionActionInjector>();
            ...
            mockResourceVersionRepository.Verify(x => x.CompleteRegisterVersion(It.IsAny<RepositoryKey>()), Times.Exactly(1));
        }
        ...
        public void Execute_リポジトリ2つ()
        {
            ...
            mockResourceVersionRepository1.Verify(x => x.CompleteRegisterVersion(It.IsAny<RepositoryKey>()), Times.Exactly(1));
            mockResourceVersionRepository2.Verify(x => x.CompleteRegisterVersion(It.IsAny<RepositoryKey>()), Times.Exactly(1));
        }
