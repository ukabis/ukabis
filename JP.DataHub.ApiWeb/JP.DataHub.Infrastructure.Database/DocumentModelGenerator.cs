...
//     Connection String:      `Server=tcp:jpdatahubdev.database.windows.net,1433;Initial Catalog=DocumentSqlServer;Persist Security Info=False;User ID=agri;Password=******;`
//     Include Views:          `True`
...
namespace JP.DataHub.Infrastructure.Database.Document
{
    ...
    {
        [DbMap("Document","File","file_id")]
        file_id,
        [DbMap("Document","File","document_id")]
        document_id,
        [DbMap("Document","File","title")]
        title,
        [DbMap("Document","File","url")]
        url,
        [DbMap("Document","File","is_enable")]
        is_enable,
        [DbMap("Document","File","reg_date")]
        reg_date,
        [DbMap("Document","File","reg_username")]
        reg_username,
        [DbMap("Document","File","upd_date")]
        upd_date,
        [DbMap("Document","File","upd_username")]
        upd_username,
        [DbMap("Document","File","is_active")]
        is_active,
        [DbMap("Document","File","file_update_date")]
        file_update_date,
        [DbMap("Document","File","html_link")]
        html_link,
        [DbMap("Document","File","order_no")]
        order_no,
    }
