...
//     Connection String:      `Server=tcp:jpdatahubdev.database.windows.net,1433;Initial Catalog=AuthoritySqlServer;Persist Security Info=False;User ID=;Password=******;`
//     Include Views:          `True`
...
namespace JP.DataHub.Infrastructure.Database.Authority
{
    ...
    {
        [DbMap("Authority","System_Multi_Language","system_lang_id")]
        system_lang_id,
        [DbMap("Authority","System_Multi_Language","system_id")]
        system_id,
        [DbMap("Authority","System_Multi_Language","locale_code")]
        locale_code,
        [DbMap("Authority","System_Multi_Language","system_name")]
        system_name,
        [DbMap("Authority","System_Multi_Language","reg_date")]
        reg_date,
        [DbMap("Authority","System_Multi_Language","reg_username")]
        reg_username,
        [DbMap("Authority","System_Multi_Language","upd_date")]
        upd_date,
        [DbMap("Authority","System_Multi_Language","upd_username")]
        upd_username,
        [DbMap("Authority","System_Multi_Language","is_active")]
        is_active,
    }
    public enum AuthorityVendorMultiLanguage
    {
        [DbMap("Authority","Vendor_Multi_Language","vendor_lang_id")]
        vendor_lang_id,
        [DbMap("Authority","Vendor_Multi_Language","vendor_id")]
        vendor_id,
        [DbMap("Authority","Vendor_Multi_Language","locale_code")]
        locale_code,
        [DbMap("Authority","Vendor_Multi_Language","vendor_name")]
        vendor_name,
        [DbMap("Authority","Vendor_Multi_Language","reg_date")]
        reg_date,
        [DbMap("Authority","Vendor_Multi_Language","reg_username")]
        reg_username,
        [DbMap("Authority","Vendor_Multi_Language","upd_date")]
        upd_date,
        [DbMap("Authority","Vendor_Multi_Language","upd_username")]
        upd_username,
        [DbMap("Authority","Vendor_Multi_Language","is_active")]
        is_active,
    }
    ...
    {
        [DbMap("Authority","Client_Certificate","clientcertificate_id")]
        clientcertificate_id,
        [DbMap("Authority","Client_Certificate","client_certificate_string")]
        client_certificate_string,
        [DbMap("Authority","Client_Certificate","vendor_id")]
        vendor_id,
        [DbMap("Authority","Client_Certificate","system_id")]
        system_id,
        [DbMap("Authority","Client_Certificate","reg_date")]
        reg_date,
        [DbMap("Authority","Client_Certificate","reg_username")]
        reg_username,
        [DbMap("Authority","Client_Certificate","upd_date")]
        upd_date,
        [DbMap("Authority","Client_Certificate","upd_username")]
        upd_username,
        [DbMap("Authority","Client_Certificate","is_active")]
        is_active,
    }
    public enum AuthorityAccessToken
    {
        [DbMap("Authority","Access_Token","accesstoken_id")]
        accesstoken_id,
        [DbMap("Authority","Access_Token","client_id")]
        client_id,
        [DbMap("Authority","Access_Token","system_id")]
        system_id,
        [DbMap("Authority","Access_Token","expiration_datetime")]
        expiration_datetime,
        [DbMap("Authority","Access_Token","reg_date")]
        reg_date,
        [DbMap("Authority","Access_Token","reg_username")]
        reg_username,
        [DbMap("Authority","Access_Token","upd_date")]
        upd_date,
        [DbMap("Authority","Access_Token","upd_username")]
        upd_username,
        [DbMap("Authority","Access_Token","is_active")]
        is_active,
    }
    public enum AuthorityAdminFunc
    {
        [DbMap("Authority","Admin_Func","admin_func_id")]
        admin_func_id,
        [DbMap("Authority","Admin_Func","admin_name")]
        admin_name,
        [DbMap("Authority","Admin_Func","reg_date")]
        reg_date,
        [DbMap("Authority","Admin_Func","reg_username")]
        reg_username,
        [DbMap("Authority","Admin_Func","upd_date")]
        upd_date,
        [DbMap("Authority","Admin_Func","upd_username")]
        upd_username,
        [DbMap("Authority","Admin_Func","is_active")]
        is_active,
        [DbMap("Authority","Admin_Func","display_description")]
        display_description,
    }
    public enum AuthorityAdminFuncRole
    {
        [DbMap("Authority","Admin_Func_Role","admin_func_role_id")]
        admin_func_role_id,
        [DbMap("Authority","Admin_Func_Role","admin_func_id")]
        admin_func_id,
        [DbMap("Authority","Admin_Func_Role","role_id")]
        role_id,
        [DbMap("Authority","Admin_Func_Role","is_read")]
        is_read,
        [DbMap("Authority","Admin_Func_Role","is_write")]
        is_write,
        [DbMap("Authority","Admin_Func_Role","reg_date")]
        reg_date,
        [DbMap("Authority","Admin_Func_Role","reg_username")]
        reg_username,
        [DbMap("Authority","Admin_Func_Role","upd_date")]
        upd_date,
        [DbMap("Authority","Admin_Func_Role","upd_username")]
        upd_username,
        [DbMap("Authority","Admin_Func_Role","is_active")]
        is_active,
    }
    ...
    {
        [DbMap("Authority","Staff_Role","staff_role_id")]
        staff_role_id,
        [DbMap("Authority","Staff_Role","staff_id")]
        staff_id,
        [DbMap("Authority","Staff_Role","role_id")]
        role_id,
        [DbMap("Authority","Staff_Role","reg_date")]
        reg_date,
        [DbMap("Authority","Staff_Role","reg_username")]
        reg_username,
        [DbMap("Authority","Staff_Role","upd_date")]
        upd_date,
        [DbMap("Authority","Staff_Role","upd_username")]
        upd_username,
        [DbMap("Authority","Staff_Role","is_active")]
        is_active,
    }
    ...
    {
        [DbMap("Authority","System_Admin","system_admin_id")]
        system_admin_id,
        [DbMap("Authority","System_Admin","system_id")]
        system_id,
        [DbMap("Authority","System_Admin","admin_secret")]
        admin_secret,
        [DbMap("Authority","System_Admin","is_enable")]
        is_enable,
        [DbMap("Authority","System_Admin","reg_date")]
        reg_date,
        [DbMap("Authority","System_Admin","reg_username")]
        reg_username,
        [DbMap("Authority","System_Admin","upd_date")]
        upd_date,
        [DbMap("Authority","System_Admin","upd_username")]
        upd_username,
        [DbMap("Authority","System_Admin","is_active")]
        is_active,
    }
    public enum AuthoritySystemFunc
    {
        [DbMap("Authority","System_Func","systemfunc_id")]
        systemfunc_id,
        [DbMap("Authority","System_Func","system_id")]
        system_id,
        [DbMap("Authority","System_Func","function_id")]
        function_id,
        [DbMap("Authority","System_Func","reg_date")]
        reg_date,
        [DbMap("Authority","System_Func","reg_username")]
        reg_username,
        [DbMap("Authority","System_Func","upd_date")]
        upd_date,
        [DbMap("Authority","System_Func","upd_username")]
        upd_username,
        [DbMap("Authority","System_Func","is_active")]
        is_active,
    }
    public enum AuthorityUserInvitation
    {
        [DbMap("Authority","User_Invitation","user_invitation_id")]
        user_invitation_id,
        [DbMap("Authority","User_Invitation","mailaddress")]
        mailaddress,
        [DbMap("Authority","User_Invitation","vendor_id")]
        vendor_id,
        [DbMap("Authority","User_Invitation","invitation_date")]
        invitation_date,
        [DbMap("Authority","User_Invitation","expire_date")]
        expire_date,
        [DbMap("Authority","User_Invitation","register_staff_id")]
        register_staff_id,
        [DbMap("Authority","User_Invitation","register_account")]
        register_account,
        [DbMap("Authority","User_Invitation","is_used")]
        is_used,
        [DbMap("Authority","User_Invitation","reg_date")]
        reg_date,
        [DbMap("Authority","User_Invitation","reg_username")]
        reg_username,
        [DbMap("Authority","User_Invitation","upd_date")]
        upd_date,
        [DbMap("Authority","User_Invitation","upd_username")]
        upd_username,
        [DbMap("Authority","User_Invitation","is_active")]
        is_active,
        [DbMap("Authority","User_Invitation","role_id")]
        role_id,
        [DbMap("Authority","User_Invitation","staff_id")]
        staff_id,
    }
