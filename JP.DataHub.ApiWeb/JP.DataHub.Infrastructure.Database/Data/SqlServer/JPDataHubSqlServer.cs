...
namespace JP.DataHub.Infrastructure.Database.Data.SqlServer
{
    /// <summary>
    /// SqlServerデータアクセス(DynamicAPIリポジトリ用)
    /// </summary>
    public class JPDataHubSqlServer : AbstractJPDataHubRdbms
    {
        private static readonly object _LockObj = new object();

        protected override JPDataHubLogger Log => new JPDataHubLogger(typeof(JPDataHubSqlServer));
        protected override string ProviderInvariantName => "System.Data.SqlClient";
        ...
        public JPDataHubSqlServer() : base()
        {
        }
