...
namespace JP.DataHub.ManageApi.Models.ApiMailTemplate
{
    public class ApiMailTemplateViewModel
    {
        /// <summary>APIメールテンプレートID</summary>
        [Required(ErrorMessage = "必須項目です。")]
        public Guid ApiMailTemplateId { get; set; }
