...
namespace JP.DataHub.ManageApi.Models.DynamicApi
{
    public class MethodViewModel
    {
        ...
        /// セカンダリリポジトリグループリスト
        /// </summary>
        public IEnumerable<SecondaryRepositoryViewModel> SecondaryRepositoryMapList { get; set; }

        /// <summary>
        /// サンプルコードリスト
        /// </summary>
        public IEnumerable<DynamicApiSampleCodeViewModel> SampleCodeList { get; set; }

        /// <summary>
        /// リンクリスト
        /// </summary>
        public IEnumerable<DynamicApiMethodLinkViewModel> MethodLinkList { get; set; }

        /// <summary>
        /// アクセスベンダーリスト
        /// </summary>
        public IEnumerable<AccessVendorViewModel> AccessVendorList { get; set; }

        /// <summary>
        /// OpenId認証局リスト
        /// </summary>
        public IEnumerable<MethodOpenIdCAViewModel> MethodOpenIdCAList { get; set; }
    }
}
