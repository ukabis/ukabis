...
{
    public record VendorSystemAccessToken : IValueObject
    {
        ...
        public VendorSystemAccessToken(string value)
        {
            Value = value;
        ...
        public static bool operator ==(VendorSystemAccessToken me, object other) => me?.Equals(other) == true;
