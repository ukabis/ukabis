...
{
    class CompleteRegisterVersionActionInjector : ActionInjector
    {
        public override void Execute(Action action)
        {
            ...
            var parallelResult = target.DynamicApiDataStoreRepository
                ...
                .Select(repository =>
                {
                    ...
                    try
                    {
                        var result = repository.ResourceVersionRepository.CompleteRegisterVersion(target.RepositoryKey);
                        //var result = repository.CompleteRegisterVersion(target.RepositoryKey, repository.RepositoryInfo);
                        return result;
                    }
