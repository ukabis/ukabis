...
namespace JP.DataHub.ApiWeb.Infrastructure.WebRequest
{
    ...
    public interface IWebRequestManager
    {
        ...
        /// リクエスト結果
        /// </returns>
        Task<HttpResponseMessage> GetAsync(string requestUri, TimeSpan? timeout = null);
        ...
        /// <param name="timeout">timeout</param>
        /// <returns></returns>
        Task<HttpResponseMessage> JsonGetAsync(string requestUri, TimeSpan? timeout = null);
        ...
        /// <param name="timeout">timeout</param>
        /// <returns>リクエスト結果</returns>
        Task<HttpResponseMessage> JsonPostAsync(string requestUri, HttpContent content, TimeSpan? timeout = null);
