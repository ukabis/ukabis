...
namespace JP.DataHub.ApiWeb.Infrastructure.Models.Database
{
    ...
    public class AllApiEntity : IAllApiEntityIdentifier
    {
        [Key(0)]
        ...
        [Key(63)]
        public Guid? controller_schema_id { get; set; }
        [Key(65)]
        ...
        [Key(113)]
        public bool is_require_consent { get; set; }
        [Key(114)]
        public string terms_group_code { get; set; }
        [Key(115)]
