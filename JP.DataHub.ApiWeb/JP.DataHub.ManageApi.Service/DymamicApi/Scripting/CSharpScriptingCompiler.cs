...
{
    internal class CSharpScriptingCompiler : IScriptingCompiler
    {
        private static readonly JPDataHubLogger s_logger = new JPDataHubLogger(typeof(CSharpScriptingCompiler));
        ...
        private ScriptOptions _option = ScriptOptions.Default.WithImports("System.Net", "Newtonsoft.Json", "Newtonsoft.Json.Linq", "JP.DataHub.ManageApi.Service.DymamicApi.Scripting.Roslyn", "Unity").WithReferences(Assembly.Load("Newtonsoft.Json"), Assembly.Load("JP.DataHub.ManageApi.Service"), Assembly.Load("Unity.Interception"), Assembly.Load("System.Net.Http"), Assembly.Load("AutoMapper")).WithEmitDebugInformation(true);
