...
namespace IT.JP.DataHub.ApiWeb.TestCase
{
    [Ignore("Mongo系限定")]
    [TestClass]
    public class ContainerDynamicSeparationPersonPrivateTest : ApiWebItTestCase
    {
        #region TestData
        ...
        private class ContainerDynamicSeparationTestData : TestDataBase
        {
            ...
            public AreaUnitModel DataGetA1 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "3A1",
                ConversionSquareMeters = 1,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~PersonPrivate~{WILDCARD}~A1",
                _Owner_Id = WILDCARD
            };
            public AreaUnitModel DataGetA2 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "3A2",
                ConversionSquareMeters = 2,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~PersonPrivate~{WILDCARD}~A2",
                _Owner_Id = WILDCARD
            };
            ...
            public AreaUnitModel DataGetB1 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "2B1",
                ConversionSquareMeters = 1,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~PersonPrivate~{WILDCARD}~B1",
                _Owner_Id = WILDCARD
            };
            public AreaUnitModel DataGetB2 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "2B2",
                ConversionSquareMeters = 2,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~PersonPrivate~{WILDCARD}~B2",
                _Owner_Id = WILDCARD
            };
            ...
            public AreaUnitModel DataGetC1 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "1C1",
                ConversionSquareMeters = 1,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~PersonPrivate~{WILDCARD}~C1",
                _Owner_Id = WILDCARD
            };
            public AreaUnitModel DataGetC2 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "1C2",
                ConversionSquareMeters = 2,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~PersonPrivate~{WILDCARD}~C2",
                _Owner_Id = WILDCARD
            };
            ...
            public ContainerDynamicSeparationTestData(string resourceUrl) : base(Repository.MongoDbCds, resourceUrl, false, true) { }
        }
        ...
        [TestMethod]
        public void ContainerDynamicSeparationTest_PersonPrivateScenario()
        {
            var api = UnityCore.Resolve<IContainerDynamicSeparationPersonPrivateApi>();
            ...
            // 別ユーザーで同じIDのデータを登録しても別々のコンテナに保管される
            // Register
            ...
            // Query
            clientA.GetWebApiResponseResult(api.GetAll()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetA1, testData.DataGetA2, testData.DataGetC1, testData.DataGetC2 });
            clientB.GetWebApiResponseResult(api.GetAll()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetB1, testData.DataGetB2 });
            clientC.GetWebApiResponseResult(api.GetAll()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetA1, testData.DataGetA2, testData.DataGetC1, testData.DataGetC2 });

            // OData
            clientA.GetWebApiResponseResult(api.OData()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetA1, testData.DataGetA2, testData.DataGetC1, testData.DataGetC2 });
            clientB.GetWebApiResponseResult(api.OData()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetB1, testData.DataGetB2 });
            clientC.GetWebApiResponseResult(api.OData()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetA1, testData.DataGetA2, testData.DataGetC1, testData.DataGetC2 });
            ...
            // 別コンテナ1件
            clientA.GetWebApiResponseResult(api.GetOverPartition("B1")).Assert(GetSuccessExpectStatusCode, testData.DataGetB1);
            clientB.GetWebApiResponseResult(api.GetOverPartition("A2")).Assert(GetSuccessExpectStatusCode, testData.DataGetA2);
            clientC.GetWebApiResponseResult(api.GetOverPartition("B2")).Assert(GetSuccessExpectStatusCode, testData.DataGetB2);

            // ODataクエリ: $filter=ConversionSquareMeters eq 2&$orderby=AreaUnitName&$top=2&$select=AreaUnitCode
            expected = new List<AreaUnitModel>() { testData.DataSelectedC2, testData.DataSelectedB2 };
            ...
            expected = new List<AreaUnitModel>() { testData.DataSelectedB2, testData.DataSelectedC2 };
