...
namespace IT.JP.DataHub.ApiWeb.TestCase
{
    [Ignore("Mongo系限定")]
    [TestClass]
    public class ContainerDynamicSeparationDoublePrivateTest : ApiWebItTestCase
    {
        #region TestData
        ...
        private class ContainerDynamicSeparationTestData : TestDataBase
        {
            ...
            public AreaUnitModel DataGetA1 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "3A1",
                ConversionSquareMeters = 1,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~DoublePrivate~{WILDCARD}~A1",
                _Owner_Id = WILDCARD
            };
            public AreaUnitModel DataGetA2 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "3A2",
                ConversionSquareMeters = 2,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~DoublePrivate~{WILDCARD}~A2",
                _Owner_Id = WILDCARD
            };
            ...
            public AreaUnitModel DataGetB1 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "2B1",
                ConversionSquareMeters = 1,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~DoublePrivate~{WILDCARD}~B1",
                _Owner_Id = WILDCARD
            };
            public AreaUnitModel DataGetB2 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "2B2",
                ConversionSquareMeters = 2,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~DoublePrivate~{WILDCARD}~B2",
                _Owner_Id = WILDCARD
            };
            ...
            public AreaUnitModel DataGetC1 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "1C1",
                ConversionSquareMeters = 1,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~DoublePrivate~{WILDCARD}~C1",
                _Owner_Id = WILDCARD
            };
            public AreaUnitModel DataGetC2 = new AreaUnitModel()
            {
                ...
                AreaUnitName = "1C2",
                ConversionSquareMeters = 2,
                id = $"API~IntegratedTest~ContainerDynamicSeparation~DoublePrivate~{WILDCARD}~C2",
                _Owner_Id = WILDCARD
            };
            ...
            public ContainerDynamicSeparationTestData(string resourceUrl) : base(Repository.MongoDbCds, resourceUrl, true, true) { }
        }
        ...
        [TestMethod]
        public void ContainerDynamicSeparationTest_DoublePrivateScenario()
        {
            var api = UnityCore.Resolve<IContainerDynamicSeparationDoublePrivateApi>();
            ...
            clientC.GetWebApiResponseResult(api.GetAll()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetC1, testData.DataGetC2 });
            ...
            clientC.GetWebApiResponseResult(api.OData()).Assert(GetSuccessExpectStatusCode, new List<AreaUnitModel>() { testData.DataGetC1, testData.DataGetC2 });
            ...
            clientB.GetWebApiResponseResult(api.GetOverPartition("C2")).Assert(GetSuccessExpectStatusCode, testData.DataGetC2);
            ...
            expected = new List<AreaUnitModel>() { testData.DataSelectedA2, testData.DataSelectedB2, testData.DataSelectedC2 };
