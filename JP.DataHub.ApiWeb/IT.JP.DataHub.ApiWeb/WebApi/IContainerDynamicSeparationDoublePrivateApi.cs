...
{
    [WebApiResource("/API/IntegratedTest/ContainerDynamicSeparation/DoublePrivate", typeof(AreaUnitModel))]
    public interface IContainerDynamicSeparationDoublePrivateApi : ICommonResource<AreaUnitModel>
    {
        [WebApi("GetAll")]
