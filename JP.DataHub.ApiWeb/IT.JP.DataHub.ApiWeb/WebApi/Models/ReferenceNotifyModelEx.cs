...
namespace IT.JP.DataHub.ApiWeb.WebApi.Models
{
    ...
    /// Ref1がnullプロパティあり
    /// </summary>
    public class ReferenceNotifyModelEx : BaseModel
    {
    ...
    /// <summary>
    /// Ref11、Ref12、Ref13がnullプロパティあり
    /// </summary>
    public class ReferenceNotifyModelEx2 : BaseModel
    {
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public string Code { get; set; }
    ...
    /// Ref11、Ref12が型違い
    /// </summary>
    public class ReferenceNotifyModelEx3 : BaseModel
    {
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public string Code { get; set; }
