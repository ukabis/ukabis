...
{
    [WebApiResource("/API/IntegratedTest/ContainerDynamicSeparation", typeof(AreaUnitModel))]
    public interface IContainerDynamicSeparationApi : ICommonResource<AreaUnitModel>
    {
        [WebApi("GetAll")]
