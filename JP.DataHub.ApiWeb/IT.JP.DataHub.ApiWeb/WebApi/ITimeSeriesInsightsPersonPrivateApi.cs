...
{
    [WebApiResource("/API/IntegratedTest/TimeSeriesInsightsPersonPrivateTest", typeof(ObservationModel))]
    public interface ITimeSeriesInsightsPersonPrivateApi : ICommonResource<ObservationModel>
    {
        [WebApi("GetAll")]
