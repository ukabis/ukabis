...
{
    internal class ServiceBusNotificationService : AbstractNotificationService, INotificationService
    {
        private static readonly JPDataHubLogger s_logger = new JPDataHubLogger(typeof(ServiceBusNotificationService));
