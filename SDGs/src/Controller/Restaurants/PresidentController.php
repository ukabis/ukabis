                ...
                try {
                    $conn->transactional(function ($conn) use ($business, $office) {
                        if ($this->Businesses->saveOrFail($business)) {
                            ...
                            $office->office_type = OFFICE_RESTAURANT;
                            ...
                            if (!empty($profileImage1->getSize())) {
                                $dataProfileImage1 = $this->uploadService->uploadAndConvertToPNG($profileImage1, OFFICE_RESTAURANT);
                                $office->profile_image_1 = $dataProfileImage1['path'];
                            }
                            if (!empty($profileImage2->getSize())) {
                                $dataProfileImage2 = $this->uploadService->uploadAndConvertToPNG($profileImage2, OFFICE_RESTAURANT);
