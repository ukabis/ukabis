...
require __DIR__ . DIRECTORY_SEPARATOR . 'constants/common.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'constants/role.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'constants/rank.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'constants/message.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'constants/options.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'restaurant_questions.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'restaurant_questions_score.php';
