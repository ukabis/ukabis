 ...
 */
?>
<?php $this->assign('title', '飲食店 生産者検索一覧ページ');?>
		...
		<section class="name_sec request_edit">
			...
			<section class="contents_sec registered pt0pb0 edit request_list request_search_list">
				...
				<div class="contents">
					...
					<?php if (count($resultFarmRequests)): ?>
						<?php $listTitle = []; ?>
						<?php foreach ($resultFarmRequests as $keyRequest => $request): ?>
							<?php
							$title = [];
							foreach ($dataRestaurantRequests as $item) {
