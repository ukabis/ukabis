...
<section class="content">
    <article class="wrap_contents pb1rem">
        ...
        <section class="contents_sec registered pt0pb0 edit">
            ...
            <div class="contents">
            <h4 class="ragist_title">企業情報を登録</h4>
            ...
            <div class="contents">
            <h4 class="ragist_title">店舗情報を登録</h4>
            <div class="edit_input">
                <?php
                    ...
                    echo '<p class="ragistration_img_btn">' . $this->Form->label('ragistration-img-btn-1', '店舗自己紹介画像 1', [
                    ...
                    echo '<p class="ragistration_img_btn">' . $this->Form->label('ragistration_img_btn_2', '店舗自己紹介画像 2', [
                        'class' => 'ragistration_img_btn'
                    ]) . '</p>';
            ...
            <p class="edit_save_btn"><?= $this->Form->button('登録する'); ?></p>
            </div>
            <?= $this->Form->end(); ?>
        </section>
    </article>
