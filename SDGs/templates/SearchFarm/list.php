 ...
 */
?>
<?php $this->assign('title', '認証生産者 検索結果 一覧ページ');?>
        ...
        <div class="contents">
          <div class="wrap_registered_menu">
            <div class="registered_menu_title">
				<div class="registered_name_title user">生産者／農産物</div>
            ...
            <?php if (count($offices)): ?>
				...
				<div class="registered_menu_box">
					<div class="registered_name_detail user">
						<?php
							$title = $office->name;
							if ($office->LastFarmRequest['food']) {
								$title .=  '／' . $office->LastFarmRequest['food'];
							}
						?>
						<a href="<?= '/search/farm/'. $office->id .'?' . $query ?>">
							<?= h($title) ?>
						</a>
					</div>
