...
<?php $this->assign('title', '生産者 編集ページ');?>
        ...
        <section class="contents_sec registered pt0pb0 edit">
            ...
            <div class="edit_input">
                <?php
                    ...
                    echo '<p class="ragistration_img_btn">' . $this->Form->label('ragistration-img-btn-1', $office->profile_image_1 ? '店舗自己紹介画像 1(' . str_replace('uploads/producers/', '', $office->profile_image_1) . ')' : '店舗自己紹介画像 1', [
                    ...
                    echo '<p class="ragistration_img_btn">' . $this->Form->label('ragistration_img_btn_2', $office->profile_image_2 ? '店舗自己紹介画像 2(' . str_replace('uploads/producers/', '', $office->profile_image_2) . ')' : '店舗自己紹介画像 2', [
                        'class' => 'ragistration_img_btn'
                    ]) . '</p>';
