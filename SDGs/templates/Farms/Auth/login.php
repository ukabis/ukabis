 ...
 */
?>
<?php $this->assign('title', '生産者申請者トップページ');?>
    ...
    <div class="wrap_page">
        <article class="main_area">
			...
			<section class="common_btn_sec mb50">
				<p><?= $this->Form->button('ログイン', ['class' => 'farm_btn login_btn']); ?></p>
			</section>
			<?= $this->Form->end() ?>
			<section class="common_btn_sec">
				<h3>ログインIDをお持ちでない方は<br>こちらから登録ください。</h3>
				<p><button class="farm_btn new_registration"><a href="./register" class="fs16">新規登録</a></button></p>
			</section>
        </article>
    </div>
</section>
