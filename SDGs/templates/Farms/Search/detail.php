...
<section class="content store_page">
        ...
        <section class="contents_sec registered pt0pb0">
            ...
            <div class="contents">
                <table class="registered_detail_table">
                    ...
                    <?php if ($restaurantRequest): ?>
                    <tr>
                        <th>いまどき！リクエスト</th>
                    </tr>
                    <tr>
                        <td class="now_comment"><?= $restaurantRequest->comment ?></td>
                    </tr>
                    <tr>
                        <th>書き込み日時</th>
                    </tr>
                    <tr>
                        <td><?= $this->CustomHtml->dateformatJapan($restaurantRequest->created_at) ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                        <th>店舗自己紹介</th>
