...
<template>
    ...
    <div class="bg">
        <div class="content" ref="contentRef">
            <div class="msg_wrap">
                トレース終了（最終入荷）でよろしいでしょうか？<br />
                （センサーでの測定を終了します）
            </div>
            <div class="btn_group">
                <ClearBlackLetterBtn btn-label="トレースを継続する" input-width="auto" @click="clickContinue" />
                <BlackBgBtn btn-label="トレースを終了する" input-width="auto" @click="clickEnd" />
            </div>
        </div>
    </div>
    <Footer />
